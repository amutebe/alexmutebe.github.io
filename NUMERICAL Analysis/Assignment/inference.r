...
# Since data is non parametric we are using the wilcoxon rank sum test to test whether there is a statistical difference between men and women on the Valid height variable.
...
# Since data is non parametric we are using the wilcoxon rank sum test to test whether there is a statistical difference between men and women on the Valid Weight variable.
